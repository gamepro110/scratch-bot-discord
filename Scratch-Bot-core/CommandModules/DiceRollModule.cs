...
namespace Scratch_Bot_core.Modules
{
    ...
    class DiceRoll
    {
        ...
        {
            value = new Random().Next(0, (int)diceType) + 1;
            return this;
        }

        public int value;
        private DiceType diceType { get; init; }
    }
    ...
    [Group("Roll")]
    public class DiceRollModule : CustomBaseModule
    {

        public DiceRollModule(CommandService _commandService, LoggingService _loggingService, Random random)
        {
